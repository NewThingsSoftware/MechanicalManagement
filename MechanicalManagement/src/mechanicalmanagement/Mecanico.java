...
@NamedQueries({
    ...
    @NamedQuery(name = "Mecanico.findByMecanico", query = "SELECT m FROM Mecanico m WHERE m.telefone = :telefone"),
...
public class Mecanico implements Serializable{
    ...
    public Mecanico(Integer idmMecanico, String nome, int cpf, int rg,String especialidade ,boolean status) {
        this.idMecanico = idmMecanico;
        this.nome = nome;
        this.cpf = cpf;
        this.rg = rg;
    ...
    public void setIdMecanico(Integer idMecanico) {
        ...
        this.idMecanico = idMecanico;
        changeSupport.firePropertyChange("idCliente", oldIdMecanico, idMecanico);
    }

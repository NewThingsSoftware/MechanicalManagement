 ...
 * @author Bruno
 */
public class MecanicoComboBoxModel extends AbstractListModel implements MutableComboBoxModel {

    private Object selectedItem;
    private List list;

    public MecanicoComboBoxModel() {
        this.list = new ArrayList();
    }

    public MecanicoComboBoxModel(List<Mecanico> mecanicos) {
        this.list = new ArrayList();
        for (Mecanico mecanico : mecanicos) {
            list.add(mecanico.getNome());
        }
    }
